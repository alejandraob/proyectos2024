...
productList.push({
    ...
    stock: 5,
    detalle:
        "Billetara de cuero para mujer con cierre y compartimentos para tarjetas",
});
productList.push({
    ...
    stock: 4,
    detalle:
        "Billeta de cuero con grabado personalizado y compartimentos para tarjetas",
});
productList.push({
    name: "Bolso p/Asado",
    price: 25000,
    ...
    stock: 1,
    detalle:
        "Bolso de cuero para transportar utensillos de asado, con compartimentos",
});
...
productList.push({
    ...
    stock: 0,
    detalle:
        "Cartera de cuero con diseño personalizado y cinta adaptable al hombro",
});
productList.push({
    name: "Cartera ",
    price: 37000,
...
productList.push({
    ...
    stock: 0,
    detalle:
        "Macetas recicladas con latas de cerveza. Dibujos y colores realizados a mano",
});
productList.push({
...
for (product of productList) {
    ...
    (function (product) {
        ...
        productImg.addEventListener("click", () =>
            openProductDetailAside(product.name)
        );
    })(product);
